...
class LazyPositionShade {
    //: static let shared = AppPermissionTool()
    static let shared = LazyPositionShade()

    /// 获取麦克风权限
    //: func requestMicPermission(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    func head(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    func root(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
        //: if #available(iOS 14, *) {
        if #available(iOS 14, *) {
    ...
    func permission(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
